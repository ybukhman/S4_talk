...
scifi_chars = data.frame(name = c("Mr. Hop", "Commander Data", "Darth Vader"),
                         description = c("sapient frog","android","evil lord"),
                         starship = c("Star Warts", "Enterprise", "Death Star"),
                         likability = c(10,10,0)
                         )
as(scifi_chars,"Characters_df")
```
(The error was thrown because we forgot to include the action column)
...
## Document classes and methods with roxygen2
